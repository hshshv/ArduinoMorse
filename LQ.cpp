...
void LQ::PrintHebrowString(String text)
{
  ...
  for (int i = 0; i < 16 && i <= text.length(); ++i)
  {
    ...
    {
      int X = 0;
      case 'א': ThisChar = HebrewCharecters[0]; break;
      case 'ב': ThisChar = HebrewCharecters[1]; break;
      case 'ג': ThisChar = HebrewCharecters[2]; break;
      case 'ד': ThisChar = HebrewCharecters[3]; break;
      case 'ה': ThisChar = HebrewCharecters[4]; break;
      case 'ו': ThisChar = HebrewCharecters[5]; break;
      case 'ז': ThisChar = HebrewCharecters[6]; break;
      case 'ח': ThisChar = HebrewCharecters[7]; break;
      case 'ט': ThisChar = HebrewCharecters[8]; break;
      case 'י': ThisChar = HebrewCharecters[9]; break;
      case 'כ': ThisChar = HebrewCharecters[10]; break;
      case 'ל': ThisChar = HebrewCharecters[11]; break;
      case 'מ': ThisChar = HebrewCharecters[12]; break;
      case 'נ': ThisChar = HebrewCharecters[13]; break;
      case 'ס': ThisChar = HebrewCharecters[14]; break;
      case 'ע': ThisChar = HebrewCharecters[15]; break;
      case 'פ': ThisChar = HebrewCharecters[16]; break;
      case 'צ': ThisChar = HebrewCharecters[17]; break;
      case 'ק': ThisChar = HebrewCharecters[18]; break;
      case 'ר': ThisChar = HebrewCharecters[19]; break;
      case 'ש': ThisChar = HebrewCharecters[20]; break;
      case 'ת': ThisChar = HebrewCharecters[21]; break;
      case 'ך': ThisChar = HebrewCharecters[22]; break;
      case 'ם': ThisChar = HebrewCharecters[23]; break;
      case 'ן': ThisChar = HebrewCharecters[24]; break;
      case 'פ': ThisChar = HebrewCharecters[25]; break;
      case 'ץ': ThisChar = HebrewCharecters[26]; break;
      break;
    }
